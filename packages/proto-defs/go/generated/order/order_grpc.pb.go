...
type OrderServiceClient interface {
	...
	GetOrderById(ctx context.Context, in *OrderIdRequest, opts ...grpc.CallOption) (*Order, error)
}
...
func (c *orderServiceClient) GetOrderById(ctx context.Context, in *OrderIdRequest, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
...
type OrderServiceServer interface {
	...
	GetOrderById(context.Context, *OrderIdRequest) (*Order, error)
...
func (UnimplementedOrderServiceServer) GetOrderById(context.Context, *OrderIdRequest) (*Order, error) {
...
func _OrderService_GetOrderById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrderById(ctx, req.(*OrderIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
